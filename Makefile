...
build/mod_chat_log_mongodb: build repo/mod_chat_log_mongodb
	cd repo/mod_chat_log_mongodb && ./build.sh && cp ebin/* /lib/ejabberd/ebin

build/mod_admin_extra_custom: build repo/mod_admin_extra_custom
	cd repo/mod_admin_extra_custom && ./build.sh && cp ebin/* /lib/ejabberd/ebin

build/erlmongo: build repo/erlmongo
	cd repo/erlmongo && erl -make && cp ebin/* /lib/ejabberd/ebin
...
rebuild/mod_chat_log_mongodb: repo/mod_chat_log_mongodb
	...
	./build.sh && cp ebin/* /lib/ejabberd/ebin
